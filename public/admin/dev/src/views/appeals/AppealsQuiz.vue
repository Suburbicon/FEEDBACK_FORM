...
import appealsForm from './AppealQuiz'
...
export default {
    ...
    data: () => {
        return {
            ...
            fields: [
                ...
                {key: 'liked', label: 'Понравившееся', sortable: true},
                {key: 'not_liked', label: 'Непонравившееся', sortable: true},
    ...
    methods: {
        ...
        refresh() {
            this.$store.dispatch('appeals/getAppealsQuizDataInStorage').catch(error => {
                console.log(error)
            })
        }
    },
